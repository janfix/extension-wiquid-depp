...
namespace oat\wiquid\model\update;
...
/**
 * Description of ItemFixblobDefaultValue
 *
 * @author sam
 */
class ItemFixblobDefaultValue extends ItemUpdater
{
    /**
    ...
    protected function updateItem(Item $item, $itemFile)
    {
        ...
        foreach ($interactions as $interaction) {
            if ($interaction instanceof PortableCustomInteraction && $interaction->getTypeIdentifier() === 'blobInteraction') {
