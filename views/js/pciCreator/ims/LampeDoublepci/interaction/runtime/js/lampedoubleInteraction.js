...
define([
    ...
    'lampedoublePCI/interaction/runtime/js/renderer',
    ...
    qtiCustomInteractionContext.register(lampedoubleInteraction);

    return lampedoubleInteraction;
});