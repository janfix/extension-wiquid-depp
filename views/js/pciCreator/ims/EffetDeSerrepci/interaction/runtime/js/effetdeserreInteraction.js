...
define([
    ...
    'effetdeserrePCI/interaction/runtime/js/renderer',
    ...
    qtiCustomInteractionContext.register(effetdeserreInteraction);

    return effetdeserreInteraction;
});