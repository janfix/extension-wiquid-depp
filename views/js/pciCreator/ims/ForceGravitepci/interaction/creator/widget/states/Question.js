...
define([
    ...
    'tpl!forcegravitePCI/interaction/creator/tpl/propertiesForm',
    'lodash',
    'jquery'
    ...
    forcegraviteInteractionStateQuestion.prototype.initForm = function() {

        $(".forcegraviteInteraction").parent().parent().find('.state-switcher').hide();
