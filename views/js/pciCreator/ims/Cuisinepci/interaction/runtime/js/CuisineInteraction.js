...
define([
    ...
    'CuisinePCI/interaction/runtime/js/renderer',
    'taoQtiItem/portableLib/OAT/util/event'
], function(qtiCustomInteractionContext, $, renderer, event) {
    'use strict';

    var _typeIdentifier = 'CuisinePCI';

    var CuisineInteraction = {
        ...
        getResponse: function() {
            ...
            var $container = $(this.dom),
                value = '{'+
                    '"Bouilloire": '+ parseInt($container.find('.boilerAnsw').html()) +","+
                    '"Chocolat": '+ parseInt($container.find('.chocoAnsw').html()) + "," +
                    '"Feu": '+ parseInt($container.find('.feuAnsw').html()) + "," +
                    '"Tartre": '+ parseInt($container.find('.tartreAnsw').html())
                +'}';
    ...
    qtiCustomInteractionContext.register(CuisineInteraction);

    return CuisineInteraction;
});