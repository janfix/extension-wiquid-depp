...
define([
    ...
    'tpl!delorPCI/interaction/creator/tpl/propertiesForm',
    'lodash',
    'jquery'
    ...
    delorInteractionStateQuestion.prototype.initForm = function() {

        $(".delorInteraction").parent().parent().find('.state-switcher').hide();
