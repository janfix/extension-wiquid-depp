...
define([
    ...
    'nterrePCI/interaction/runtime/js/renderer',
    ...
    var nterreInteraction = {
        ...
        getResponse: function() {
            ...
            var $container = $(this.dom),
                distance = $container.find('.distanceAsw').text(),
                masse = $container.find('.masseAsw').text(), 
                rayon = $container.find('.rayonAsw').text();
            var value = '{"distance":'+distance+',"masse":'+masse+' ,"rayon":'+rayon+'}' 
    ...
    qtiCustomInteractionContext.register(nterreInteraction);

    return nterreInteraction;
});