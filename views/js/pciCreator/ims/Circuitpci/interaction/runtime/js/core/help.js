    ...
    function($, assets, deppAssets, demoAssets) {
        ...
        function renderHelp($container, config) {
            ...
            var chapter0 = '<div class="chapter"><h1>Inventaire des composants</h1><p>Laisser la souris sur le bouton du composant pour faire apparaître sa définition.</p><ul class="no-bullets">' + '<li><img class="middle"  width="30px" src="' + icoGrab.src + '"/> : Permet de saisir les composants, une fois qu\'ils ont été posés sur l\'espace de travail</li>' +
                ...
                '</ul> </div>'
            var chapter1 = '<div class="chapter"><h1>Ajouter un composant sur l\'espace de travail</h1><p>Cliquer sur un des boutons « Composant ». Un point blanc apparait sur l\’espace de travail. Maintenir le bouton gauche de la souris, le dipôle apparait. Déplacer la souris pour ajuster la taille du dipôle. Relâcher le bouton de la souris. </br>Si les extrémités de deux composants se touchent, une connexion se crée entre les composants.</p></div>';
            var chapter2 = '';
            var chapter3 = '<div class="chapter"><h1>Modifier les composants</h1><p>Utiliser l\'outil <img class="middle" width="50px" src="' + icoGrab.src + '"/> pour sélectionner un composant. Déplacer la souris à l\’extrémité du composant. Un point bleu apparait.<br /> Cliquer sur ce point pour modifier la longueur des fils ou pour faire pivoter/bouger le composant. </p><img class="demoImg" src="' + demoAssets.pointBleu + '"> <h2>Supprimer un composant</h2><p>Sélectionner le composant avec l’outil  <img class="middle" width="50px" src="' + icoGrab.src + '"/>. Appuyer sur la touche « Suppr » du clavier. <p>Si un composant est sélectionné. Seul ce composant sera supprimé.</p><p> Si une connexion entre deux composants est sélectionnée. Les deux composants seront supprimés.</p><h2> Déconnecter un composant du circuit</h2><p>Approcher la souris d’une connexion. Un tiret bleu apparait.</p><p>Cliquer sur le tiret et déplacer le. Les composants ne sont plus connectés.</p><img class="demoImg" src="' + demoAssets.selectConnect + '"><img class="demoImg" src="' + demoAssets.deconnect + '"><h2>Etirer le circuit</h2><p>Sélectionner une connexion avec l\'outil <img class="middle" width="50px" src="' + icoGrab.src + '"/>   . Un point bleu apparait sur la connexion.</p> <p>Déplacer le point bleu avec la souris. Le circuit est étiré par cet angle.</p><img class="demoImg" src="' + demoAssets.selectExtr + '"><img class="demoImg" src="' + demoAssets.deform + '"><p>Sélectionner un composant entier avec l’outil <img class="middle" width="50px" src="' + icoGrab.src + '"/> . Un trait bleu apparait sur le composant.</p><p> Déplacer le trait bleu. Le circuit est étiré par un coté.</p><img class="demoImg" src="' + demoAssets.selectCompo + '"><img class="demoImg" src="' + demoAssets.etirer + '"></div>'
