    ...
    function($, assets, deppAssets, demoAssets) {
        ...
        function renderHelp($container, config) {
            ...
            var chapter0 = '<div class="chapter"><h1>Inventaire des composants</h1><p>Laisser la souris sur le bouton du composant pour faire apparaître sa définition.</p><ul class="no-bullets">' + '<li><img class="middle"  width="30px" src="' + icoGrab.src + '"/> : Permet de saisir les composants, une fois qu\'ils ont été posés sur l\'espace de travail</li>' +
                ...
                '</ul> </div>'
            var chapter1 = '<div class="chapter"><h1>Ajouter un composant sur l\'espace de travail</h1><p>Cliquer sur un des boutons « Composant ». Un point blanc apparait sur l\’espace de travail. Maintenir le bouton gauche de la souris, le dipôle apparait. Déplacer la souris pour ajuster la taille du dipôle. Relâcher le bouton de la souris. Si les extrémités de deux composants se touchent, une connexion se crée entre les composants.</p></div>';
            var chapter2 = '';
