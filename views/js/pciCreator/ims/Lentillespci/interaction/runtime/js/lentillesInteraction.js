...
define([
    ...
    'lentillesPCI/interaction/runtime/js/renderer',
    ...
    qtiCustomInteractionContext.register(lentillesInteraction);

    return lentillesInteraction;
});